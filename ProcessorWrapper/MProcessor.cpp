...
namespace handinput {
  ...
  void MProcessor::Update(float x, float y, float z, System::IntPtr image, bool visualize) {
    processor_->Update(x, y, z, reinterpret_cast<IplImage*>(image.ToPointer()), visualize);
  }
}
